...
float Gate = 12.5; // PWM3, initialized to close position
float Switch = 6.3; // PWM4, initialized to blue side
...
//			}
		...
		if ((timecount%200)==0) {
			LCDPrintfLine(1,"x:%.2f,y:%.2f %i",ROBOTps.x,ROBOTps.y, ifblue);
